...
/* globals define */
define('views/layout/navigation',['jquery'], function($) {
...
define('views/layout/email_capture',['jquery'], function($) {
...
define('views/homepage/map',[], function() {
...
var coverVid = function (elem, width, height) {
	...
	elem.parentNode.style.overflowX = 'hidden';
...
;
define("vendor/covervid", function(){});

/* globals define */
define('views/homepage/homepage',[
    'jquery',
    'views/homepage/map',
    'vendor/covervid'
], function($, maps) {
...
/* globals define */
define('views/android/downloads',[
    'jquery',
    'handlebars'
], function($, Handlebars) {
...
/* globals define */
define('views/subpage/contact_form',['jquery'], function($) {
